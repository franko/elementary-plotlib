...
int main() {
    ...
    elp_plot_set_label_angle(plot, elp_x_axis, 3.141592 / 4);
    elp_plot_enable_label_format(plot, elp_x_axis, "%.2f");
    ...
    elp_plot_add(plot, path_as_object(line), elp_color_red, 2.5, elp_color_yellow, elp_fill | elp_stroke);
    ...
    elp_plot_add(plot, path_as_object(line2), elp_color_blue, 2.5, elp_color_none, elp_stroke);
