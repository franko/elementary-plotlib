...
#include "window_wx.h"
#include "wx/elem/basewindow.h"
#include "wx/elem/starthandler.h"

window_wx::window_wx(graphics::window_surface& window_surface):
...
window_wx::window_wx(graphics::window_surface& window_surface, wxElemStartHandler *start_handler):
        window_wx(window_surface) {
    m_start_handler = start_handler;
}

window_wx::window_wx(graphics::window_surface& window_surface, wxElemBaseWindow *elem_window):
        window_wx(window_surface) {
    elem_window->setWindowWx(this);
...
void window_wx::bind_elem_window(wxElemBaseWindow *elem_window) {
...
void window_wx::start(unsigned width, unsigned height, unsigned flags, window_close_callback *callback) {
