...
The same program can be made even more simple like in the code below::
...
- removed the InitializeFonts() function
- used the Show() and Wait() methods on the plot object, without creating a window.

The InitializeFonts() function can be omitted because it is called automatically when the first window is created.
